<nav class="navbar navbar-expand-md navbar-inverse navbar-laravel">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link disabled" href="/posts" tabindex="-1" aria-disabled="true">Blog</a>
      </li>
                        ...
                        @else
                            <!-- <li class="nav-item dropdown">
                             ...
                             <!--    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                 ...
                                 <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="/home" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dashboard</a>
        <div class="dropdown-menu" aria-labelledby="dropdown01">
         <a class="dropdown-item" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
